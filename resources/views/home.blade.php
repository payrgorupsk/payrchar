        ...
        $.ajax({
            ...
            .done(function (response) {
                ...
                $.each(response.data, function (key,value) {
                    ...
                    var html = "";
                    html += '<div class="post"><div class="post-heading"><div class="post-avature"><img onerror="'+demoImage+'" src="public/uploads/' + value.user.profile_image + '" alt=""></div><div class="post-title"><h4><a href="<?=URL::to('/');?>/profile/'+value.user.username+'">' + value.user.first_name + ' ' + value.user.last_name + '</a></h4><p> <i class="uil-users-alt"></i> </p></div><div class="post-btn-action"><span class="icon-more uil-ellipsis-h"></span><div class="mt-0 p-2" uk-dropdown="pos: bottom-right;mode:hover "><ul class="uk-nav uk-dropdown-nav"><li><a href="#"> <i class="uil-share-alt mr-1"></i> Share</a> </li><li><a href="#"> <i class="uil-edit-alt mr-1"></i> Edit Post </a></li><li><a href="#"> <i class="uil-comment-slash mr-1"></i> Disable comments</a></li><li><a href="#"> <i class="uil-favorite mr-1"></i> Add favorites </a></li><li><a href="#" class="text-danger"> <i class="uil-trash-alt mr-1"></i>Delete </a></li></ul></div></div></div>';
